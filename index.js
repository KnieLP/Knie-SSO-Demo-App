...
app.post('/token', function(request, response) {
    ...
    if((username == 'clientid') && (password == 'clientsecret')) { 
        ...
        if(request.body.code == "secretcode"){
            ...
            var token = jwt.sign({ 
                "iss": "https://enigmatic-shelf-93460.herokuapp.com/",
                "sub": "4252134334433434334432", //becomes customer id in Customer Info SDE
                "preferred_username" : "Johoe", //becomes username in Customer Info SDE
                "phone_number" : "+1-10-323223323244-65333", //becomes imei in Customer Info SDE
                "given_name" : "Tet", //becomes first part of name in Personal Info SDE
                "family_name" : "Test2", //becomnes second part of name in Personal Info SDE
                "email" : "emil@email.com", //becomes Email adress in Peresonal Info SDE
                "gender" : "Mae", //becomes gender in Personal Info SDE 
                "lp_sdes":[
                    {
                     "type":"ctmrinfo",
                     "info":{
